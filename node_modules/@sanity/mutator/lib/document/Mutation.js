  ...
  compile() {
    ...
    this.mutations.forEach(mutation => {
      if (mutation.create) {
        ...
        operations.push(doc => doc === null ? Object.assign(mutation.create, { _createdAt: mutation.create._createdAt || this.params.timestamp }) : doc);
      } else if (mutation.createIfNotExists) {
        operations.push(doc => doc === null ? Object.assign(mutation.createIfNotExists, { _createdAt: mutation.createIfNotExists._createdAt || this.params.timestamp }) : doc);
