...
class StatelessSearchableSelect extends _react2.default.PureComponent {
  ...
  render() {
    ...
    const onClear = _props4.onClear,
          ...
          rest = _objectWithoutProperties(_props4, ['onClear', 'placeholder', 'isLoading', 'value', 'items', 'renderItem', 'isOpen', 'highlightIndex', 'isInputSelected', 'inputValue', 'onChange', 'onInputChange', 'onOpen', 'onClose', 'onResize', 'dropdownPosition', 'disabled', 'onHighlightIndexChange', 'openItemElement']);
