...
function createButtonLike(Component, { displayName, defaultProps = {} }) {
  ...
  return _temp2 = _class = class ButtonLike extends _react2.default.Component {
    ...
    render() {
      ...
      const style = (0, _classnames2.default)(className, [_defaultStyle2.default.root, _defaultStyle2.default[kind], inverted && _defaultStyle2.default.inverted, color && _defaultStyle2.default[`color__${color}`], disabled && _defaultStyle2.default.disabled, recentlyHovered && _defaultStyle2.default.recentlyHovered, !children && _defaultStyle2.default.onlyIcon]);
