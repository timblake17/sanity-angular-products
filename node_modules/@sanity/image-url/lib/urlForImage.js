...
const SPEC_NAME_TO_URL_NAME_MAPPINGS = [['width', 'w'], ['height', 'h'], ['format', 'fm'], ['download', 'dl'], ['blur', 'blur'], ['sharpen', 'sharp'], ['invert', 'invert'], ['orientation', 'or'], ['minHeight', 'min-h'], ['maxHeight', 'max-h'], ['minWidth', 'min-w'], ['maxWidth', 'max-w'], ['quality', 'q'], ['fit', 'fit'], ['crop', 'crop']];
...
function parseAssetId(ref) {
  ...
  const imgWidthStr = _dimensionString$spli2[0],
...
function specToImageUrl(spec) {
  const baseUrl = `https://cdn.sanity.io/images/${spec.projectId}/${spec.dataset}/${spec.asset.id}-${spec.asset.width}x${spec.asset.height}.${spec.asset.format}`;
